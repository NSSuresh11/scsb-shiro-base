...
public abstract class AuthenticatingRealm extends CachingRealm implements Initializable {
     ...
     * default implementation of the {@link Realm#supports(AuthenticationToken)} method to
     ...
     * value is a {@link SimpleCredentialsMatcher SimpleCredentialsMatcher} instance.
     *
     ...
     *         set.
     * @see #setAuthenticationCache(Cache)
     * @see #isAuthenticationCachingEnabled()
     * @since 1.2
     */
     ...
     * a cache is not explicitly configured via {@link #setAuthenticationCache(Cache)}.
     * <p/>
     ...
     *                                via {@link #setAuthenticationCache(Cache)}.
     * @see #isAuthenticationCachingEnabled()
     * @since 1.2
     */
