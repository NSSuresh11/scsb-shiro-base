...
public interface FilterChainManager {
     ...
     * <code>{@link #addFilter(String, Filter, boolean) addFilter}(name, filter, <b>false</b>);</code>
     *
     ...
     * {@link #addFilter(String, Filter) registered} with the manager, and</li>
     ...
     * @throws IllegalArgumentException if there is not a {@link #addFilter(String, Filter) registered}
     ...
     *                                  {@link PathConfigProcessor PathConfigProcessor}
     *                                  interface).
     */
