 ...
 * {@code request.}{@link ServletRequest#isSecure() isSecure()}.  If either condition is {@code false},
...
public class SslFilter extends PortFilter {
     ...
     *{@code ServletRequest.}{@link ServletRequest#isSecure() isSecure()}.  If the port does not match or
     ...
     * {@code request.}{@link ServletRequest#isSecure() isSecure()}, {@code false} otherwise.
