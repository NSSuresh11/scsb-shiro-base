 ...
 * {@link PathMatchingFilter currently matching path}.</li>
...
public class HttpMethodPermissionFilter extends PermissionsAuthorizationFilter {
     ...
     * action based on the HTTP request {@link HttpServletRequest#getMethod() method}.
     *
     ...
     * {@link #buildPermissions(HttpServletRequest, String[], String) buildPermissions} request
