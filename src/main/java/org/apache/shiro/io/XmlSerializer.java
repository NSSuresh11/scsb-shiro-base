 ...
 * {@link XMLEncoder XMLEncoder} and {@link XMLDecoder XMLDecoder} to serialize
...
public class XmlSerializer implements Serializer {
     ...
     * {@link XMLEncoder XMLEncoder} to encode the object out to a
     * {@link ByteArrayOutputStream ByteArrayOutputStream}, where the resulting byte[] array is returned.
     ...
     * {@link ByteArrayInputStream ByteArrayInputStream} to wrap the argument and then decode this
     * stream via an {@link XMLDecoder XMLDecoder}, where the
     * {@link XMLDecoder#readObject() readObject} call results in the original Object to return.
